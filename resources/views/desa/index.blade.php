    ...
    <div class="container-fluid d-flex align-items-center">
        <div class="row">
            <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">{{ $desa_nama }}</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body pt-0 pt-md-4 pt-5">
                <div class="text-center">
                    ...
                    <div class="h5 font-weight-300">
                        Kec. Soropia, Kab. {{ $desa->nama_kabupaten }}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update-desa', $desa) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama_desa" type="text" id="nama_desa" class="form-control form-control-alternative @error('nama_desa') is-invalid @enderror" placeholder="Masukkan nama desa" value="{{ old('nama_desa', $desa_nama) }}">
                        @error('nama_desa')
