...
@section('title', 'Website Resmi Pemerintah Desa . {{$desa_nama}} . - Berita')

@section('styles')
<meta name="description" content="Macam-macam berita {{$desa_nama}}, Kecamatan Soropia, Kabupaten {{ $desa->nama_kabupaten }}.">
