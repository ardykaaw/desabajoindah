...
@section('title', 'Desa ' . $desa_nama . ' - Buat ' . $surat->nama)

@section('styles')
<meta name="description" content="Buat {{ $surat->nama }} di Website {{$desa_nama}}, Kecamatan Soropia, Kabupaten {{ $desa->nama_kabupaten }}">
@endsection
