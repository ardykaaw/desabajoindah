    ...
    <div style="margin:1cm">
        <div style="height:100px;width:100%" class="mb-5">
            ...
            <div class="text-center lh-20px">
                ...
                <span style="font-size: 14pt" class="font-weight-bold">DESA {{ Str::upper({{$desa_nama}}) }}</span><br>
        ...
        @if ($surat->perihal == 1)
            ...
            <div style="margin-left: 50%; width: 50%" class="text-center float-right">
                <p style="margin-bottom: 55px">Bajo Indah, {{ $tanggal }}<br>Kepada {{ $perihal[3] }}</p>
                <p>Di - {{ $perihal[4] }}</p>
            </div>
        @else
