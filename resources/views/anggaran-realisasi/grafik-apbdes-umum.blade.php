...
<p class="text-white">Grafik Anggaran Pendapatan Belanja {{$desa_nama}}, masyarakat dapat dengan mudah mengetahui informasi mengenai Grafik Anggaran Pendapatan Belanja {{$desa_nama}}.</p>
@endsection
