...
@section('title', 'Desa ' . $desa_nama . ' - Pemerintahan Desa ' . $pemerintahan_desa->judul)

@section('styles')
<meta name="description" content="{{ $pemerintahan_desa->judul }} Pemerintahan {{$desa_nama}}, Kecamatan Soropia, Kabupaten {{ $desa->nama_kabupaten }}.">
